...
function buildCompatibleGroups(primary: StorefrontProductCard[], supplemental: StorefrontProductCard[]) {
...
export default async function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const peopleAlsoBought = homeData.mostViewedProducts
    ...
    .slice(0, 4);
  const compatibleGroups = buildCompatibleGroups(relatedCandidates, peopleAlsoBought);
