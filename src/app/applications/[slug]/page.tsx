...
import { getProductList, type StorefrontProductCard } from '@/server/storefront';
...
function ApplicationProductCard({ product, locale }: { product: StorefrontProductCard; locale: string }) {
  return (
