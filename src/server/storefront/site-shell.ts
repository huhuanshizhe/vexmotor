import type { BrandStory, FooterContactBlock, HomeFooterSection, NavigationData, NewsletterModule, SupportPage, StorefrontServiceHighlight } from './types';

const productLinks = [
  {
    label: 'Stepper Motor',
    href: '/products?keyword=Stepper%20Motor',
    children: [
      { label: 'Nema 8 Stepper Motor', href: '/products?keyword=Nema%208%20Stepper%20Motor' },
      { label: 'Nema 11 Stepper Motor', href: '/products?keyword=Nema%2011%20Stepper%20Motor' },
      { label: 'Nema 14 Stepper Motor', href: '/products?keyword=Nema%2014%20Stepper%20Motor' },
      { label: 'Nema 16 Stepper Motor', href: '/products?keyword=Nema%2016%20Stepper%20Motor' },
      { label: 'Nema 17 Stepper Motor', href: '/products?category=nema-17-stepper-motor' },
      { label: 'Nema 23 Stepper Motor', href: '/products?category=nema-23-stepper-motor' },
      { label: 'Nema 24 Stepper Motor', href: '/products?keyword=Nema%2024%20Stepper%20Motor' },
      { label: 'Nema 34 Stepper Motor', href: '/products?keyword=Nema%2034%20Stepper%20Motor' },
    ],
  },
  { label: 'Power Supply', href: '/products?category=power-supplies' },
  { label: 'Stepper Motor Driver', href: '/products?category=stepper-drivers' },
  { label: 'Closed Loop Stepper Motor', href: '/products?keyword=Closed%20Loop%20Stepper%20Motor' },
  { label: 'Brushless Spindle Motor', href: '/products?keyword=Brushless%20Spindle%20Motor' },
  { label: 'Brushless DC Motor', href: '/products?keyword=Brushless%20DC%20Motor' },
  { label: 'Integrated Stepper Motor', href: '/products?keyword=Integrated%20Stepper%20Motor' },
];
...
export const homeHeroSlides = [
  {
    label: 'Contact Us',
    href: '/contact',
    imageSrc: 'https://www.vexmotor.com/modules/cz_imageslider/views/img/49439aaed7c5afe45ee274551d13ee8ad217b95d_banner606-3.jpg',
    alt: 'Contact support banner',
    description: 'Talk directly with StepMotech about sourcing, lead times, and technical questions.',
  },
  {
    label: 'From $2.99',
  ...
  {
    label: 'Free Shipping',
    href: '/support/free-shipping',
    imageSrc: 'https://www.vexmotor.com/modules/cz_imageslider/views/img/c07f59be042de7ced48f894e83e5be57187d367f_banner606-2.jpg',
    alt: 'Free shipping promotion banner',
    description: 'Orders above $299 qualify for the duty-covered shipping promise from the old site.',
  },
  {
    label: 'Stepper Motor',
...
export const storefrontNavigationBase: Omit<NavigationData, 'categories'> = {
  ...
  mainLinks: [
    ...
    },
    {
      ...
      href: '/resources',
      children: [
        { label: 'Engineering Resources', href: '/resources' },
        { label: 'Applications', href: '/applications' },
        { label: 'Blog', href: '/blog' },
        { label: 'Technical FAQ', href: '/tech-faq' },
        { label: 'Glossary', href: '/glossary' },
        { label: 'Whitepapers', href: '/resources/whitepapers' },
        { label: 'Videos', href: '/resources/videos' },
        { label: 'Webinars', href: '/resources/webinars' },
        { label: 'Downloads', href: '/resources/downloads' },
        { label: 'CAD Library', href: '/resources/cad' },
        { label: 'Datasheet Library', href: '/resources/datasheet' },
      ],
    },
...
export const footerSupportLinks: HomeFooterSection['links'] = [
  ...
  { label: 'Volume Pricing', href: '/volume-pricing' },
  { label: 'Clearance & Duty', href: '/support/clearance-duty' },
  { label: 'Tracking My Order', href: 'https://www.17track.net/en', external: true },
  { label: 'Terms of Sale & Use', href: '/legal/terms' },
...
export const footerContactBlocks: FooterContactBlock[] = [
  ...
  },
  {
    ...
    lines: ['Floor 4, Building B, 391 Jiangdong Middle Road, Jianye District, Nanjing, China 210019'],
  },
  {
    title: 'Technical Support Center & Warehouse',
    lines: ['885 Zhangjing Road, Dongjing Town, Songjiang District, Shanghai, China 201600'],
  },
];
...
export const footerServiceHighlights: StorefrontServiceHighlight[] = [
  {
    title: 'Free Shipping',
    description: 'Free shipping and duties on orders $299+.',
  },
  {
    title: 'Easy Returns',
    description: 'Fast returns processed within 30 days.',
  },
  {
  ...
  },
  {
    ...
    description: 'Quick support during business hours.',
  },
];
...
export const supportPages: SupportPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Payments can be processed in multiple major currencies, with final settlement affected by exchange rates or fees charged by the customer’s financial institution.',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'A tracking number is sent to the customer’s email after dispatch.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Customers in markets with stricter import requirements, such as India, Türkiye, Brazil, and South Africa, are expected to confirm that they are qualified for customs clearance before ordering.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          'The legacy page promotes free shipping and duty-free handling on qualified orders, positioning the offer around StepMotech’s sea freight program.',
